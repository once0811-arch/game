...
func _service_products() -> Array[Dictionary]:
	...
	return [
		{"id": "service_remove", "type": "service", "service": "remove", "title": "Remove Card", "price": price_after_discount(remove_price), "description": "Choose a card to remove from the deck."},
		{"id": "service_upgrade", "type": "service", "service": "upgrade", "title": "Upgrade Card", "price": price_after_discount(upgrade_price), "description": "Choose an unupgraded card."},
		{"id": "service_transform", "type": "service", "service": "transform", "title": "Transform Card", "price": price_after_discount(transform_price), "description": "Choose a card to turn into a reward card."},
		{"id": "service_copy", "type": "service", "service": "copy", "title": "Copy Card", "price": price_after_discount(copy_price), "description": "Choose a card to copy into discard."},
	]
