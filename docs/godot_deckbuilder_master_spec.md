...
| 이름 | 슬롯 | 범위 | 효과 | 가격 |
|---|---|---|---|---:|
| 선봉대 철투구 | 투구 | 팀 | 모든 동료 기본 공격 피해 +1 | 90 |
...
| 무거운 대검 | 무기 | 장착자 | 장착자의 기본 공격 피해 +4, 첫 턴 드로우 -1 | 90 |
...
| 방 | 가격 | 효과 |
|---|---:|---|
| 작은 방 | 40골드 | 최대 체력 20% 회복 |
| 좋은 방 | 90골드 | 최대 체력 45% 회복 |
| 귀족 방 | 130골드 | 최대 체력 70% 회복 |
