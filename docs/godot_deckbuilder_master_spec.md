...
> **중세 판타지 세계에서 균형형 주인공이 동료와 서약 전술을 맺고, 유대 점수를 쌓으며 3막을 돌파하는 동료 중심 싱글플레이 2D 로그라이크 덱빌딩 게임.**
...
중세 판타지 세계에서 균형형 주인공이 동료와 서약 전술을 맺고 유대 점수를 쌓으며 3막을 돌파하는, **동료 시스템 중심의 싱글플레이 2D 로그라이크 덱빌딩 게임**.
...
60점: 신뢰. 패시브 수치 소폭 강화.
100점: 서약 완성. 동료별 작은 완성 보너스와 런 결과 문구 가능.
```
...
수호 맹세: 이번 턴 받는 피해를 2 이상 줄이면 다음 턴 시작 시 카드 1장 추가 드로우. 턴당 1회.
