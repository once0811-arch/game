...
현재 목적: 4에너지/6드로우 구조, 전술 표식, 자해-에너지, 약한 회복의 기본 재미 검증
```
...
브람 계열: 자해 카드, 고위험 피해, 에너지 환급
마렌 계열: 약한 회복, 방어 보조, 등가교환식 유틸
토르 계열: 큰 방어, 저체력 버티기, 표식 대상 파괴
리나 계열: 전술 표식 증폭, 스킬 카드, 회복-표식 연결
노아 계열: 드로우, 0비용 카드, 카드 수 카운트
이솔 계열: 위기 회복, 방어-회복 연결, 보호
카일 계열: 자해 감수, 방어적 후퇴, 5승 단위 랜덤 판돈 보상
```
