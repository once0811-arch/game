...
`seen_companion_ids`는 Act 1 동료 흔적 이벤트에서 본 후보를 저장한다. Act 1 중간 보스 후 첫 동료 3택은 이 목록에서 최소 1명을 포함할 수 있다.
...
5. 카드 사용, 전술 표식, 적 처치
6. 보상 생성과 카드 보상 스킵
7. 맵 1Act 흐름과 Act 1 동료 흔적 이벤트
8. Act 1 중간 보스와 첫 동료 영입
9. Act 1 보스와 두 번째 동료 영입
10. 동료 전투 공격
11. 서약 전술 발동
12. 유대 점수 누적
13. 엘리트/Act 2 강화
